...
class Generator(nn.Module):
    def __init__(self):
        ...
        nn.BatchNorm2d(20),
        nn.ReLU(),
        nn.Conv2d(in_channels = 20,out_channels = 20,kernel_size = (5,5),stride = 2),
        nn.BatchNorm2d(20),
        nn.ReLU(),
        nn.Conv2d(in_channels = 20,out_channels = 10, kernel_size = (3,3)),
        nn.BatchNorm2d(10),
        nn.ReLU(),
        nn.Conv2d(in_channels = 10,out_channels = 10,kernel_size = (3,3),stride = 2),
        nn.BatchNorm2d(10),
        nn.ReLU(),
        nn.Conv2d(in_channels = 10,out_channels = 10,kernel_size = (3,3),stride = 2),
        nn.BatchNorm2d(10),
    ...
    def forward(self, x):
        ...
        #print("Size Generator before: ",x.size())
        x = self.layer1(x)
        #print("Size Generator before 1: ",x.size())
        x = self.layer2(x)
        #print("Size Generator before 2: ",x.size())
