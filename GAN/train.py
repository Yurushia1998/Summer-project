...
train_real =  Dataset6D(train_data_real_path,key_points_path,num_objects = 1,   trans = trans,type_data = "real")
train_fake= Dataset6D(train_data_fake_path,key_points_path, num_objects = 1,  trans = trans,type_data = "fake")
...
for epoch in range(num_epoches):
    ...
    for i in range(num_iterations):
        ...
        keypoint_detector_error = criterion(keypoint_predicted, label_keypoints_flatten)
